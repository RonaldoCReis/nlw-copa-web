...
import userExampleAvatar from '../assets/users-avatar-example.png';
...
export default function Home(props: indexTypes) {
  // fetchData();
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    try {
      ...
      alert(
        'Bolão criado com sucesso, código copiado para a área de tarnsferência'
      );
    } catch (err) {
      console.log(err);
  ...
  return (
    <div className="max-w-6xl h-screen mx-auto grid grid-cols-2 gap-28 items-center ">
      <main>
        <Image src={logoImage} alt="Logo do nlw copa" />
        <h1 className="mt-14 text-white font-bold text-5xl leading-tight">
          Crie seu próprio bolão da copa e compartilhe entre amigos!
        </h1>
        <div className="mt-10 flex items-center gap-2">
          <Image src={userExampleAvatar} alt="Exemplo dos Avatares" />
        ...
        <p className="text-gray-300 mt-4 text-sm leading-relaxed w-96">
          Após criar seu bolão, você receberá um código único que poderá usar
          para convidar outras pessoas 🚀
        </p>
        <div className="mt-10 pt-10 border-t border-gray-600 flex justify-between text-gray-100">
          <div className="flex items-center gap-6">
            <Image src={iconCheckImage} alt="Icone Check"></Image>
